          ...
          {authorized ? (
            ...
            <div className="login-screen">
              <p className="login-text">
                This is a temporary login screen. By clicking login, the test
                auth token should be saved locally to your computer. After you
                have the token saved to your computer, this screen shouldn't
                show anymore.
              </p>
